...
project = 'quarkus Ansible Collection'
...
htmlhelp_basename = 'quarkusCollectionDoc'
...
latex_documents = [
    (master_doc, 'quarkusCollection.tex', 'Quarkus Ansible Collection Documentation',
     'Red Hat, Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'quarkuscollection', 'Quarkus Ansible Collection Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'quarkusCollection', 'Quarkus Ansible Collection Documentation',
     author, 'quarkusCollection', 'One line description of project.',
     'Miscellaneous'),
]
